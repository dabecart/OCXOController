...
void PPS_IRQ() {
    ...
    if (((mcuHandlers.ppsHandler->Instance->SR & TIM_FLAG_CC1) == TIM_FLAG_CC1) && 
        ((mcuHandlers.ppsHandler->Instance->DIER & TIM_IT_CC1) == TIM_IT_CC1)) {
    ...
    if (((mcuHandlers.ppsHandler->Instance->SR & TIM_FLAG_CC2) == TIM_FLAG_CC2) && 
        ((mcuHandlers.ppsHandler->Instance->DIER & TIM_IT_CC2) == TIM_IT_CC2)) {
    ...
    if (((mcuHandlers.ppsHandler->Instance->SR & TIM_FLAG_CC3) == TIM_FLAG_CC3) && 
        ((mcuHandlers.ppsHandler->Instance->DIER & TIM_IT_CC3) == TIM_IT_CC3)) {
	    __HAL_TIM_CLEAR_FLAG(mcuHandlers.ppsHandler, TIM_FLAG_CC3);

        push_LIFO_u32(&risingOCXO, HAL_TIM_ReadCapturedValue(mcuHandlers.ppsHandler, TIM_CHANNEL_3));
        newRising = 1;
    ...
    if (((mcuHandlers.ppsHandler->Instance->SR & TIM_FLAG_CC4) == TIM_FLAG_CC4) && 
        ((mcuHandlers.ppsHandler->Instance->DIER & TIM_IT_CC4) == TIM_IT_CC4)) {
	    __HAL_TIM_CLEAR_FLAG(mcuHandlers.ppsHandler, TIM_FLAG_CC4);

        push_LIFO_u32(&fallingOCXO, HAL_TIM_ReadCapturedValue(mcuHandlers.ppsHandler, TIM_CHANNEL_4));
        newFalling = 1;
    }
